                                    ...
                                    @if (Auth::user()->email_verified_at == null)
                                        <div class="alert alert-warning py-1 px-2 fs-12 mb-2">
                                            ...
                                            <a href="{{ route('email.verify') }}"
                                                class="text-warning-emphasis fw-medium">Verify now</a>
                                        </div>
                                    @endif
                                        ...
                                        <div class="card widget-icon-box text-bg-success mb-0 h-100">
                                            <div class="card-body">
                                                <div class="d-flex justify-content-between">
                                                    <div>
                                                        <h5 class="text-uppercase fs-13 mt-0 text-white text-opacity-75">
                                                            Assign
                                                            Tasks</h5>
                                                    ...
                                                    <div class="widget-icon-box-avatar avatar-sm flex-shrink-0">
                                                        <span
                                                            class="avatar-title bg-white bg-opacity-25 text-white rounded-3 fs-3">
                                    ...
                                    <a href="{{ route('daily.issue.create') }}" class="stat-card-link">
                                        <div
                                            ...
                                            <div class="card-body">
                                                <div class="d-flex justify-content-between">
                                                    <div>
                                                        <h5 class="text-uppercase fs-13 mt-0 text-white text-opacity-75">Add
                                                            Issue
                                                        </h5>
                                    ...
                                    <a href="{{ route('daily.task.my') }}" class="stat-card-link">
                                        <div class="card widget-icon-box text-bg-success mb-0 h-100">
                                            <div class="card-body">
                                                <div class="d-flex justify-content-between">
                                                    <div>
                                                        <h5 class="text-uppercase fs-13 mt-0 text-white text-opacity-75">My
                                                            Tasks
                                                        </h5>
                                                        <h3 class="my-2 text-white">
                                                            {{ ($myTodayTasks ?? collect())->count() }}
                                                        </h3>
                                                        <p class="mb-0 text-white text-opacity-75 fs-13">Pending today</p>
                                                    </div>
                                                    <div class="widget-icon-box-avatar avatar-sm flex-shrink-0">

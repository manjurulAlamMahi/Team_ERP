...
@section('title', 'Edit Fiverr Profile')
@section('quickAccessicon', 'ri-user-star-line')

@section('content')
    <div class="row">
        <div class="col-lg-8 m-auto">
            <form action="{{ route('fiverr.profile.update') }}" method="POST">
                @csrf
                <input type="hidden" name="id" value="{{ $profile->id }}">
                <div class="card card-body">
                    <h5 class="mb-3 text-uppercase bg-light p-2">
                        <i class="ri-user-star-line"></i> Edit Fiverr Profile
                    </h5>
                        ...
                        <div class="col-9">
                            ...
                            <div class="form-check form-switch">
                                <input type="checkbox" class="form-check-input" id="statusSwitch" name="status"
                                    value="active" {{ old('status', $profile->status) == 'active' ? 'checked' : '' }}>

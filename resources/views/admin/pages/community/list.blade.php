        ...
        <div class="col-lg-12 m-auto">
            <div class="card card-body">
                <h5 class="mb-3 text-uppercase bg-light p-2 d-flex justify-content-between align-items-center">
                    <span><i class="ri-building-4-line"></i> Community List</span>
                    @can('community_create')
                        <a href="{{ route('community.create') }}" class="btn btn-sm btn-success">
                            ...
                            <tr>
                                ...
                                <td class="text-end">
                                    <div class="d-flex gap-1 justify-content-end">
                                        @can('community_edit')
                                            <a href="{{ route('community.edit', $item->id) }}" class="btn btn-sm btn-soft-secondary" title="Edit">
                                                <i class="ri-edit-line"></i>
                                            </a>
                                        @endcan
                                        @can('community_delete')
                                            <a href="javascript: void(0);" onclick="deleteCommunity({{ $item->id }})"
